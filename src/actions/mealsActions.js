...
import { FETCH_CATEGORY_BEGIN,FETCH_CATEGORY_SUCCESS,FETCH_CATEGORY_ERROR} from './actions';
import { CATEGORIES_URL, SEARCH_URL, MEAL_SINGLE_URL, MEAL_SINGLE_CATEGORY } from './../utils/constants';
import {FETCH_MEALS_BEGIN ,FETCH_MEALS_SUCCESS, FETCH_MEALS_ERROR} from './actions';
import { FETCH_SINGLE_MEAL_BEGIN ,FETCH_SINGLE_MEAL_SUCCESS , FETCH_SINGLE_MEAL_ERROR} from './actions';
import { FETCH_CATEGORY_MEALS_BEGIN,FETCH_CATEGORY_MEALS_SUCCESS , FETCH_CATEGORY_MEALS_ERROR} from './actions';
...
export const startFetchMealsBySearch = async(dispatch,searchForm)=>{
    // console.log(searchForm);
    try{
        dispatch({type: FETCH_MEALS_BEGIN});
        const response = await axios.get(`${ SEARCH_URL}${searchForm}`)
...
export const startFetchMealByCategory = async(dispatch, category)=>{
    try{
        ...
        const response = await axios.get(`${MEAL_SINGLE_CATEGORY}${category}`)
